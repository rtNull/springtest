...
<body>
<form name="" action="editcourse" method="post"
        ...
        <tr>
            ...
            <td align="left">
                <input type="text" id="courseName" name="courseName"
                       value="${course.courseName}" size="22">
                </input>
            </td>
            <input
                    type="hidden" name="id" id="id"
                    value="${course.id}"></input>
        </tr>
        <tr>
            <td align="right">简介：</td>
            <td align="left">
                <textarea id="introduction" name="introduction" rows="5" cols="50" >${course.introduction}</textarea>
            </td>
        </tr>
        <tr>
