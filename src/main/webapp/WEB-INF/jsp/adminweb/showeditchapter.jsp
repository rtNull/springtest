...
<body>
<form name="" action="editchapter" method="post"
      enctype="multipart/form-data">
    <table width="100%" border="0" align="center" cellpadding="2"
           cellspacing="0">
        <tr>
            <th colspan="2" align="center" height="50px">修改${course.courseName}&nbsp;&nbsp; ${chapter.title}章节</th>
            <input type="hidden" id="id" name="id"
                   size="22" value="${chapter.id}"/>
            <input type="hidden" id="courseId" name="courseId"
                   size="22" value="${chapter.courseId}"/>
        </tr>

        <tr>
            <td align="right">章节名：</td>
            <td align="left"><input type="text" id="title" name="title"
                                    size="22" value="${chapter.title}"/></td>
        </tr>
        <tr>
